...
namespace tagger {
  ...
  public:
    ...
    // ---------------------------------------------------------
    std::vector< std::vector<RadialHit_t > > findIntersectingChargeClusters( const std::vector<larcv::Image2D>& img_v, const std::vector<larcv::Image2D>& badch_v,
                                                                             const std::vector<float>& pos3d, const float radius,
                                                                             const std::vector<float>& thresholds );

    std::vector< RadialHit_t > findIntersectingChargeClusters( const larcv::Image2D& img, const larcv::Image2D& badch,
