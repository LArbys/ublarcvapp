...
parser.add_argument("-i",   "--input",required=True,type=str,help="Input HDF5 file.")
parser.add_argument("-c",   "--colorby",  default='trackid', help="Color mode. Option: [instance,ancestor,edep]")
parser.add_argument("-p",   "--pos-mode", default="true",type=str,help="Position mode. Option: [true,reco]")
args = parser.parse_args()

import lardly
from lardly.detectoroutline import DetectorOutline

fh5 = h5py.File(args.input, 'r')
...
triplet_truth = fh5['mcpixel_labels']
