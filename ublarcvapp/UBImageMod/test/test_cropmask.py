...
# superafile = "larcv_masks_larcv_mctruth_sample.root"
superafile = "larcv.root"

io = larcv.IOManager(larcv.IOManager.kBOTH, "", larcv.IOManager.kTickForward)
...
maskcrop_algo = ublarcvapp.UBCropMask()
...
ClassCounts.Fill()
ClassCounts.Write()
# split_algo.printElapsedTime()
split_algo.finalize()
# maskcrop_algo.printElapsedTime()
