...
std::vector<double> ublarcvapp::ncpi0::Utils::GetPosOffsets(std::vector<double> const& point, TH3F* hX, TH3F* hY, TH3F* hZ){
...
std::vector<double> ublarcvapp::ncpi0::Utils::GetOffsetsVoxel(std::vector<double> const& point,TH3F* hX, TH3F* hY, TH3F* hZ){
...
double ublarcvapp::ncpi0::Utils::TransformX(double xVal){
  double xValNew;
...
double ublarcvapp::ncpi0::Utils::TransformY(double yVal){
  double yValNew;
...
double ublarcvapp::ncpi0::Utils::TransformZ(double zVal){
  double zValNew;
...
//----------------------------------------------------------------------------
std::vector<double> ublarcvapp::ncpi0::Utils::Transform( std::vector<double> const& point){
  return
...
bool ublarcvapp::ncpi0::Utils::IsInsideBoundaries(std::vector<double> const& point){
  return !(
...
bool ublarcvapp::ncpi0::Utils::InsideFiducial(float x, float y, float z){
  return !(
       (x <    0.001) || (x >  255.999)
    || (y < -116.499) || (y > 116.499)
    || (z <    0.001) || (z > 1036.999)
...
bool ublarcvapp::ncpi0::Utils::IsTooFarFromBoundaries(std::vector<double> const& point){
  return (
...
std::vector<double> ublarcvapp::ncpi0::Utils::PretendAtBoundary(std::vector<double> const& point){
...
std::vector<int> ublarcvapp::ncpi0::Utils::getProjectedPixel( const std::vector<double>& pos3d,
...
std::vector<double> ublarcvapp::ncpi0::Utils::MakeSCECorrection (std::vector<double> newvec,
...
int ublarcvapp::ncpi0::Utils::GetSliceNumber(float resrange){
  int slicenumber;
...
float ublarcvapp::ncpi0::Utils::CalculateSliceWeight(TH1D* muon_slice,TH1D* proton_slice){
  float weight = 1.0;
